        ...
        <section className="manager-wrap" id="manager">
          <div className="manager container">
            ...
            <div className="manager-copy">
              <p className="eyebrow"><Package size={15} weight="fill" /> 皮肤管理器</p>
              <h2>管理、预览、恢复，<br />都在一个地方。</h2>
              ...
              <div className="os-downloads">
                <a className="os-button" href={`${releaseBase}/WorkBuddy-Skin-Manager-Setup-0.1.0.exe`}>
